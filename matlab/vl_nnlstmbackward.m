function [dx, dWc, dWi, dWf, dWo, dUc, dUi, dUf, dUo, dbc, dbi, dbf, dbo] = ...
    vl_nnlstmbackward(x, h0, c0, Wc, Wi, Wf, Wo, Uc, Ui, Uf, Uo, bc, bi, bf, bo, ...
    h, c, a, i, f, o, dy, varargin)
% VL_LSTMBACKWARD Backward pass for vanilla 2D-LSTM
% Syntax:
%   [dx, dWc, dWi, dWf, dWo, dUc, dUi, dUf, dUo, dbc, dbi, dbf, dbo] = ...
%       vl_lstmbackward(x, h0, c0, ...
%       Wc, Wi, Wf, Wo, Uc, Ui, Uf, Uo, bc, bi, bf, bo, ...
%       h, c, a, i, f, o, dy, varargin);
%
% Equations:
...
if isempty(h)
    [h, c, a, i, f, o] = vl_nnlstmforward(x, h0, c0, ...
        Wc, Wi, Wf, Wo, Uc, Ui, Uf, Uo, bc, bi, bf, bo, varargin{:});
end
