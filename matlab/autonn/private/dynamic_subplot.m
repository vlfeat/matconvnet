...
%
%   DYNAMIC_SUBPLOT(FIG, AX, ASPECT)
%   Specifies the desired aspect ratio (width/height). Default is 4/3.
%
%   DYNAMIC_SUBPLOT(FIG, AX, ASPECT, PROPERTY)
...
%   Joao F. Henriques, 2016
  ...
  if nargin < 3, aspect = 4/3; end
  if nargin < 4, property = 'OuterPosition'; end
