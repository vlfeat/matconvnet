function [h, c, a, i, f, o] = vl_nnlstmforward(x, h0, c0, ...
    Wc, Wi, Wf, Wo, Uc, Ui, Uf, Uo, bc, bi, bf, bo, varargin)
% VL_LSTMFORWARD Forward pass for vanilla 2D-LSTM
% Syntax:
%   [h, c, a, i, f, o] = vl_lstmforward(x, h0, c0, ...
%       Wc, Wi, Wf, Wo, Uc, Ui, Uf, Uo, bc, bi, bf, bo, varargin)
%
% Equations:
...
for t2 = startIdx2:step2:endIdx2
    for t1 = startIdx1:step1:endIdx1
        ...
        i(:,1,t1,t2,:) =  bsxfun(@plus, mtimesx(Wi,x(:,1,t1,t2,:)) + mtimesx(Ui,hpred), bi);
