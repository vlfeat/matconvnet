...
It is easy enough to combine the computational blocks of \autoref{s:blocks} in any network DAG by writing a corresponding MATLAB script. Nevertheless, \matconvnet provides a simple wrapper for the common case of a linear chain. This is implemented by the \verb!vl_simplenn! and \verb!vl_simplenn_move! functions.
